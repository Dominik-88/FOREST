/**
 * JVS Management System - Floating UI
 * Modern design + AI integration + Firebase sync
...
(function() {
    ...
    console.log('🚀 JVS Management System - Floating UI starting...');
    ...
    window.runAI = function() {
        ...
        const areasData = areas.map(function(a) {
            return a.name + ' (' + a.district + '): ' + a.area + ' m², poslední seč ' + a.last;
        }).join('; ');
        
        const prompt = 'Analyzuj tyto vodárenské areály a doporuč 3 priority pro údržbu na základě plochy a data poslední seče. Data: ' + areasData + '. Odpověz krátce česky, max 3 věty.';
    ...
    console.log('✅ JVS Management System - Floating UI loaded');
